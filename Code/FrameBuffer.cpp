...
void FrameBuffer::Create(int InWidth, int InHeight)
{
	...
	//glGenTextures(1, &ResetFrameBuffer.Handle);
	//glBindTexture(GL_TEXTURE_2D, ResetFrameBuffer.Handle);
	//glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA16F, Width, Height, 0, GL_RGBA, GL_FLOAT, nullptr);
	//glFramebufferTexture(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, ResetFrameBuffer.Handle, 0);
